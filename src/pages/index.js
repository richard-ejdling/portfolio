    ...
    <>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center gap-6 mt-8'>
        ...
        <div className='flex items-center gap-2 text-2xl'>
          <p>CV:</p>
          <a href="/CV/CV English.pdf" download className='bg-sky-600 hover:bg-sky-700 ease-in-out duration-100 px-3 py-1 rounded-full'/* 'underline underline-offset-2' */>Download</a>
          <a href="/CV/CV English.pdf" target='_blank' className='bg-sky-600 hover:bg-sky-700 ease-in-out duration-100 px-3 py-1 rounded-full'/* 'underline underline-offset-2' */>View</a>
        </div>
      </div>
